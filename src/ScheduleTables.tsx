...
export const ScheduleTables = () => {
  ...
  const handleScheduleTimeClick = useAutoCallback((tableId: string, timeInfo: { day: string; time: number }) => {
          ...
          <Stack key={tableId} width="600px">
            <Flex justifyContent="space-between" alignItems="center">
              ...
              <ScheduleTable
                ...
                schedules={schedules}
                tableId={tableId}
                onScheduleTimeClick={useAutoCallback((timeInfo) => handleScheduleTimeClick(tableId, timeInfo))}
