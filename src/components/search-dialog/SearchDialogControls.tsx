...
import { SearchOptionProps } from "./types.ts";
import {
  Box,
  Checkbox,
  CheckboxGroup,
...
import { MajorsCheckbox } from "./MajorsCheckbox.tsx";

const SearchControl = memo(({ value, onChange }: SearchOptionProps<"query">) => {
  return (
    <FormControl>
...
const CreditsControl = memo(({ value, onChange }: SearchOptionProps<"credits">) => {
  return (
    <FormControl>
...
const GradsControl = memo(({ value, onChange }: SearchOptionProps<"grades">) => {
  return (
    <FormControl>
...
const DaysControl = memo(({ value, onChange }: SearchOptionProps<"days">) => {
  return (
    <FormControl>
...
const TimesControl = memo(({ value, onChange }: SearchOptionProps<"times">) => {
  return (
    <FormControl>
...
const MajorsControl = memo(({ value, onChange, options }: SearchOptionProps<"majors"> & { options: string[] }) => {
  return (
    <FormControl>
