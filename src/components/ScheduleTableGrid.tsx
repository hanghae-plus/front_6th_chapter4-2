...
export const ScheduleTableGrid = memo(
	({memoizedOnScheduleTimeClick}: {memoizedOnScheduleTimeClick?: (timeInfo: {day: string; time: number}) => void}) => {
		return (
	...
	(prevProps, nextProps) => {
		return prevProps.memoizedOnScheduleTimeClick === nextProps.memoizedOnScheduleTimeClick
	}
)
